...
class StyleGAN2Loss(Loss):
    def __init__(self, device, G, D, augment_pipes=None, r1_gamma=10, style_mixing_prob=0, pl_weight=0,
        ...
        self.G                  = G
        self.D                  = D
        self.augment_pipes      = augment_pipes
    ...
    def run_D(self, img, c, blur_sigma=0, blur_sigma_raw=0, update_emas=False):
        ...
        if self.augment_pipes[0] is not None:
            augmented_pair = self.augment_pipes(torch.cat([img['image'],
